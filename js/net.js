...
export class NetClient {
  ...
  _onMsg(msg) {
    ...
    if (['boss','vitals','respawned','combat','shot','fireball','fire','chat','nuke','nuke_granted','terrain_reset','host','blink_fail','admin_effect'].includes(msg.t)) this._emit(msg.t, msg);
